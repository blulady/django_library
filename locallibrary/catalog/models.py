...
class Book(models.Model):
    ...
    # Author is a string rather an object because it hasn't been declared in yet in the file
    ...
    def get_absolute_url(self):
        ...
        return reverse('book-detail', args=[str(str(self.id))])


class Language(models.Model):
    """Model representing a language"""
    name = models.CharField(max_length=200,
                            help_text="Enter a book instances' language")
