...
urlpatterns = [
    ...
    path('borrowed/', views.LoanedBooksByLibrarianView.as_view(), name="all-borrowed"),
    ...
    path('bookinstance/<int:pk>/delete/', views.BookInstanceCreate.as_view(), name="bookinstance-delete")
]